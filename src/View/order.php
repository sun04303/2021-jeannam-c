                ...
                <?php foreach($list1 as $item) : ?>
                    <div class="item">
                        ...
                        <?php if($item->sale != '0') : ?>
                            ...
                            <p><span>-<?= $item->sale.'%' ?></span> <span class="order_bread"><?= (int)$item->price - (((int)$item->price*0.01)*(int)$item->sale) ?></span>\</p>
                        <?php else : ?>
                            <p><span class="order_bread"><?= $item->price ?></span>\</p> 
                        <?php endif; ?>

                        <input class="form-control" type="number" value="0" min="0" step="1" name="cnt" id="<?= $item->name ?>">
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
